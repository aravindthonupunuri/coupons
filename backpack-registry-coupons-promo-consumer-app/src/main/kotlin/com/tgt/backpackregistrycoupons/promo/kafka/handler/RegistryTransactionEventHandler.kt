...
import com.tgt.backpackregistrycoupons.service.HandleRegistryTransactionService
...
class RegistryTransactionEventHandler(
    @Inject private val handleRegistryTransactionService: HandleRegistryTransactionService,
    ...
    fun handleCouponTransaction(promoCouponRedemptionTO: PromoCouponRedemptionTO, eventHeaders: EventHeaders): Mono<EventProcessingResult> {
        return handleRegistryTransactionService.processCouponCode(promoCouponRedemptionTO)
            .map {
                if (it) {
